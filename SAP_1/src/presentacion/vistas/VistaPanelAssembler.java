...
public class VistaPanelAssembler extends JPanel {
    ...
    public VistaPanelAssembler(Modelo m, JPanel returnPanel) {
        ...
        this.txaEntrada.setBounds(100, 30, 400, 600);
        this.txaEntrada.setBackground(new Color(248, 248, 255));
        ...
        this.lblSalida.setBounds(520, 30, 350, 600);
        c.gridx = 2;
        c.gridy = 0;
        ...
        this.btnEnsamblar.setBounds(890, 60, 210, 20);
        ...
        this.btnEnviarSAP.setBounds(890, 90, 210, 20);
        ...
        this.btnDecompilar.setBounds(890, 120, 210, 20);
        ...
        this.btnSalir.setBounds(890, 150, 210, 20);
